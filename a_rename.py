...
if rename_import:
    ...
    # Main Reusable Var. Name: 'signal_main'. NOTE: LOW HANGING FRUIT APPLIED TO OUR VARIABLE NAMING for DATA (α-equiv. sub "." for -fft, -filtfilt,...) AND RENAMING FOR EACH EX. FILTERED PROCESS.
